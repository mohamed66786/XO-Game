...
h1.map(e=>{
    e.addEventListener("click",(ele)=>{
        ...
        if((four.innerHTML=='X'&&five.innerHTML=='X'&&six.innerHTML=='X') ||(four.innerHTML=='O'&&five.innerHTML=='O'&&six.innerHTML=='O')){
        ...
        if((seven.innerHTML=='X'&&eight.innerHTML=='X'&&nine.innerHTML=='X') ||(seven.innerHTML=='O'&&eight.innerHTML=='O'&&nine.innerHTML=='O')){
        ...
        if((three.innerHTML=='X'&&five.innerHTML=='X'&&seven.innerHTML=='X')||(three.innerHTML=='O'&&five.innerHTML=='O'&&seven.innerHTML=='O')){
            three.style.backgroundColor='green'
            five.style.backgroundColor='green'
            seven.style.backgroundColor='green'
        ...
        if((one.innerHTML=='X'&&five.innerHTML=='X'&&nine.innerHTML=='X')||(one.innerHTML=='O'&&five.innerHTML=='O'&&nine.innerHTML=='O')){
            one.style.backgroundColor='green'
            five.style.backgroundColor='green'
            nine.style.backgroundColor='green'
            display.innerHTML=`${one.innerHTML} Won !!! ...`
